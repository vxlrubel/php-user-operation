        ...
        <div class="p-form">
            ...
            <form class="register-form" action="<?php echo htmlspecialchars( 'inc/core-add-user.php'); ?>" method="POST">
                ...
                <div class="item-box">
                    ...
                    <input type="text" id="name" name="user-name" class="border-radius-small">
                    <?php
                ...
                <div class="item-box">
                    ...
                    <input type="text" id="email" name="user-email" class="border-radius-small">
                    <?php
                ...
                <div class="item-box">
                    ...
                    <input type="text" id="phone" name="user-phone" class="border-radius-small">
                    <?php
                ...
                <div class="item-box message">
                    ...
                    <textarea name="user-address" id="address" class="border-radius-small"></textarea>
                    <?php
                ...
                <div class="item-box">
                    <input type="submit" value="Add a new record" name="user-submit-form" class="border-radius-small">
                </div>
